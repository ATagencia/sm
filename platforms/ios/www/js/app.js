...
(function(){
  ...
  app.controller('markersController', function($scope, $compile){
    ...
    $scope.markers = [
      {
        'title' : 'Location #1',
        'content' : 'Santa Marta D.T.C.H',
        'location'  : [11.245049, -74.212670]
      }, 
      {
        'title' : 'Location #2',
        'content' : 'Santa Marta D.T.C.H',
  ...
  app.controller('pluginsController', function($scope, $compile){
    ...
    $scope.openEmailClient = function(){
      ...
      ons.ready(function(){
        ...
        cordova.plugins.email.open({
          to:      'atencionalciudadano@santamarta.gov.co',
          subject: 'Oye!',
          body:    'Que la <strong>fueza</strong> esté con usted',
          isHtml:  true
        });
    ...
    $scope.getDirectionsApple = function(){
      ...
      window.location.href = "maps://maps.apple.com/?q=11.245049,-74.212670";

    }

    $scope.getDirectionsGoogle = function(){

      var ref = window.open('http://maps.google.com/maps?q=11.245049,-74.212670', '_system', 'location=yes');
